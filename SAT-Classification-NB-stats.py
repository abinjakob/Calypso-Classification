# -*- coding: utf-8 -*-
"""
Created on Wed Apr 24 12:28:43 2024

Classification of the Spatial Auditory Attention using Gaussian Naive Bayes 
---------------------------------------------------------------------------
...
#%% NB classifier with 5 fold cross-validation 
...
# apply cros-validaion on training set to find best NB parameters
