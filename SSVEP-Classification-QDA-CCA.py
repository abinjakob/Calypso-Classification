# -*- coding: utf-8 -*-
"""
Created on Fri Apr 19 11:47:52 2024

Classification of the SSVEP signal using QDA
--------------------------------------------
...
# apply cros-validaion on training set to find best QDA parameters
...
plt.xlabel('cca coeff for 15hz')
plt.ylabel('cca coeff for 20hz')
plt.title(f'SSVEP QDA Prediction (Acc: {accuracy*100:.2f}%)')
plt.legend()
