# -*- coding: utf-8 -*-
"""
Created on Fri Apr 19 11:43:35 2024

Classification of the SSVEP signal using LDA
--------------------------------------------
...
#%% LDA classifier with 5 fold cross-validation 
...
plt.xlabel('cca coeff for 15hz')
plt.ylabel('cca coeff for 20hz')
plt.title(f'SSVEP LDA Prediction (Acc: {accuracy*100:.2f}%)')
plt.legend()
