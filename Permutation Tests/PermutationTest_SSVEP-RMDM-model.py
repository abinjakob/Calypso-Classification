# -*- coding: utf-8 -*-
"""
Created on Thu Feb 22 14:31:54 2024

Permutaiotn Test of the RMDM model for SSVEP
--------------------------------------------

A permutation test is carried to check the validity of the RMDM model 
The model is run 1000 times with shuffled data and a histogram is plotted


Feature used   : All PSD
Classification : RMDM classifier with 5-Fold crossvalidation
...
plt.axvline(x=modelAcc, color='red', linestyle='dashed', linewidth=1, label=f'model accuracy')  
...
plt.suptitle("Permutation Test of Riemannian MDM Model with PSD features")
plt.show()
