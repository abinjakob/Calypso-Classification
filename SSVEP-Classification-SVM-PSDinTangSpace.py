...
# -*- coding: utf-8 -*-
"""
Created on Wed Feb 21 21:50:18 2024

Feature used : PSD 
              
Classifier  : SVM classifier with 5-Fold crossvalidation
...
pipeline = make_pipeline(Covariances(), TangentSpace(), StandardScaler(), SVC())
